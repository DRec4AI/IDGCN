...
class MF(BaseModel):
    def __init__(self,
        ...
        self.user_embedding = nn.Embedding(self.num_users, embedding_dim, sparse=False)  #modify original  sparse=True
        self.item_embedding = nn.Embedding(self.num_items, embedding_dim, sparse=False)  #modify original  sparse=True
